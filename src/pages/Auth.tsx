              ...
              {!showForgotPassword ? (
                ...
                <div className="space-y-8">
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-6">
                    <div className="space-y-3">
                      <Label htmlFor="reset-email" className="text-base font-semibold text-gray-700">Email</Label>
                      <div className="relative">
                        <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                        <Input 
                          id="reset-email" 
                    ...
                    <div className="space-y-4">
                      ...
                      <Button 
                        ...
                        className="w-full h-14 border-2 border-gray-200 hover:border-gray-300 rounded-2xl font-semibold text-base transition-all duration-200 hover:shadow-lg bg-white/70 backdrop-blur-sm"
                      >
                        Back to Login
                      </Button>
                    </div>
