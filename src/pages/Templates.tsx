...
const Templates = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-slate-900 via-black to-slate-800 text-white">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {featuredTemplates.map((template) => (
                <Card 
                  key={template.id} 
                  className="group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border-0 bg-gradient-to-br from-white to-gray-50 overflow-hidden"
