...
import { LayoutDashboard, ListChecks, User2, GraduationCap, Briefcase, Code, MessageSquare, Settings, HelpCircle } from 'lucide-react';
...
const BuilderSidebar: React.FC<BuilderSidebarProps> = ({ onToolClick }) => {
  ...
  return (
    <div className="w-full md:w-64 bg-white border-r border-gray-200 py-6 px-4 flex flex-col">
      <h2 className="text-lg font-semibold mb-4 text-gray-800">Add Sections</h2>
      ...
      <div className="mt-8 pt-4 border-t border-gray-200">
        <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">More</h3>
